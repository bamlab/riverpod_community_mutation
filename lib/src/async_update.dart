// Importing foundation.dart also imports classes to make an object nicely
// readable in Flutter's devtool.
// If you import foundation.dart, Freezed will automatically do it for you.
// ignore: unnecessary_import
import 'package:freezed_annotation/freezed_annotation.dart';

part 'async_update.freezed.dart';
...
/// * The is no `refreshing` because we do not have a use case for it.
sealed class AsyncUpdate<TData> with _$AsyncUpdate<TData> {
  const AsyncUpdate._();
  ...
  // ignore: no-object-declaration, ok for error
